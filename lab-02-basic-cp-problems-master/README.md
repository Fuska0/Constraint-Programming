...
Assignments contain offline checkers. If you open project `lab-02.mzp`, you will see that every model has option to `run+check` instead of just `run`. The checker will give you feedback if the solution found according to your model is correct.
